...
ZAPI void ast_static_array_ts_create(AST_Expression *length_expr, AST_Type_Spec *base, AST_Type_Spec *out_ts);
...
ZAPI AST_Type_Spec *ast_static_array_ts_new(Zodiac_Context *ctx, Source_Range range, AST_Expression *length_expr, AST_Type_Spec *base);
