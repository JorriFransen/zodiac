...
ZAPI Resolve_Results resolver_cycle(Resolver *resolver);
...
ZAPI Dynamic_Array<Type_Enum_Member> resolve_enum_member_values(Zodiac_Context *ctx, AST_Declaration *decl, Scope *scope);
