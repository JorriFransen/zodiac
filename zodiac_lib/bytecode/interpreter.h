...
ZAPI void interpreter_call_ffi(Interpreter *interp, FFI_Handle ffi_handle, s64 arg_count, s64 dest_index, Type *type);
...
ZAPI void interpreter_print_slice_from_memory(Interpreter *interp, u8* mem, Type *element_type, bool quote_strings = false);
